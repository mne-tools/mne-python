...
class Dipole(TimeMixin):
    ...
    @copy_function_doc_to_method_doc_static("func:mne.viz.plot_dipole_locations")
    @verbose_static()
    def plot_locations(
        self,
        trans,
    ...
    @verbose_static("subject", "trans_not_none", "subjects_dir")
    ...
    @verbose_static("trans", "subject", "aseg", "subjects_dir")
