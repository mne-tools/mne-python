...
def data_path(path=None, force_update=False, update_path=True, download=True,
    ...
    dataset_params = {'multimodal': multimodal}
    config_key = multimodal['config_key']

    # get download path for specific dataset
    path = _get_path(path=path, key=config_key, name='multimodal')
