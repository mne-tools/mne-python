...
class _RegCovariance(BaseEstimator):
    ...
    def __init__(self, info, grad=0.1, mag=0.1, eeg=0.1, seeg=0.1, ecog=0.1,
                 ...
                 fnirs_fd_dc_amplitude=0.1, fnirs_fd_ac_amplitude=0.1,
        ...
        self.fnirs_fd_dc_amplitude = fnirs_fd_dc_amplitude
        self.fnirs_fd_ac_amplitude = fnirs_ac_ac_amplitude
...
def regularize(cov, info, mag=0.1, grad=0.1, eeg=0.1, exclude='bads',
               ...
               fnirs_cw_amplitude=0.1, fnirs_fd_dc_amplitude=0.1,
               fnirs_fd_ac_amplitude=0.1, fnirs_fd_phase=0.1,
    ...
    fnirs_fd_dc_amplitude : float (default 0.1)
        Regularization factor for fNIRS FD DC raw signals.
    ...
    regs = dict(eeg=eeg, seeg=seeg, ecog=ecog, hbo=hbo, hbr=hbr,
                ...
                fnirs_fd_dc_amplitude=fnirs_fd_dc_amplitude,
