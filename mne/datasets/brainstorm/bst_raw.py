...
def data_path(path=None, force_update=False, update_path=True, download=True,
    ...
    dataset_params = {'bst_raw': bst_raw}
    config_key = bst_raw['config_key']
    folder_name = bst_raw['folder_name']

    # get download path for specific dataset
    path = _get_path(path=path, key=config_key, name='bst_raw')
