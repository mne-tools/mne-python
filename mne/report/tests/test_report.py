...
# from mne.epochs import make_metadata, EpochsArray
...
#     data = np.random.randn(10, 5, 100)  # 10 epochs, 5 channels, 100 samples
#     info = create_info(ch_names=['ch1', 'ch2', 'ch3', 'ch4', 'ch5'], sfreq=100)
#     return EpochsArray(data, info)


# def test_add_epochs_bad_dropped(mock_epochs):
#     """Test Case 1: Bad epochs are dropped and reject/flat are defined."""
#     mock_epochs._bad_dropped = True
#     mock_epochs.reject = {'mag': 4e-12}
#     mock_epochs.flat = {'mag': 1e-13}
#     report = Report()
#     report.add_epochs(mock_epochs, title="Test Epochs")
#     assert "Rejection Thresholds" in report.html[0]
#     assert "Flat Thresholds" in report.html[0]


# def test_add_epochs_no_bad_dropped(mock_epochs):
#     """Test Case 2: Bad epochs are not dropped."""
#     mock_epochs._bad_dropped = False
#     report = Report()
#     report.add_epochs(mock_epochs, title="Test Epochs")
#     assert "Rejection Thresholds" not in report.html[0]
#     assert "Flat Thresholds" not in report.html[0]


# def test_add_epochs_reject_flat_none(mock_epochs):
#     """Test Case 3: Reject or flat is None."""
#     mock_epochs._bad_dropped = True
#     mock_epochs.reject = None
#     mock_epochs.flat = None
#     report = Report()
#     report.add_epochs(mock_epochs, title="Test Epochs")
#     assert "Rejection Thresholds" in report.html[0]
#     assert "None" in report.html[0]


# def test_add_epochs_edge_cases():
#     """Test Case 4: Edge cases like empty epochs or invalid input."""
#     report = Report()
#     # Empty epochs
#     with pytest.raises(ValueError, match="Data must be preloaded"):
#         empty_epochs = EpochsArray([], create_info([], sfreq=100))
#         report.add_epochs(empty_epochs, title="Empty Epochs")

#     # Invalid input
#     with pytest.raises(AttributeError):
#         report.add_epochs(None, title="Invalid Input")
