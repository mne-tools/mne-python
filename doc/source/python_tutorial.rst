...
It is also possible to read evoked data stored in a fif file:
    ...
    >>> evoked1 = mne.fiff.read_evoked(evoked_fname, setno=0, baseline=(None, 0), proj=True) # doctest: +ELLIPSIS
...
Or another one stored in the same file:
    ...
    >>> evoked2 = mne.fiff.read_evoked(evoked_fname, setno=1, baseline=(None, 0), proj=True) # doctest: +ELLIPSIS
    Reading ...
