...
def _do_inf_pots(mri_rr, bem_rr, mri_Q, sol):
    ...
    from ._compute_forward_numba import _bem_inf_pots
...
def _sphere_field(rrs, coils, sphere):
    ...
    """
    from ._compute_forward_numba import _do_sphere_field
...
def _eeg_spherepot_coil(rrs, coils, sphere):
    ...
    from ._compute_forward_numba import _do_eeg_spherepot_coil
...
def _magnetic_dipole_field_vec(rrs, coils, too_close="raise"):
    from ._compute_forward_numba import _compute_mdfv
