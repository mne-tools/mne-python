"""
================================================================
Try to apply sparse solver to leadfield (Olaf).
================================================================
...
############################## OH ############
# make Evoked object with leadfield
evoked = mne.pick_channels_evoked(evoked, include=forward['info']['ch_names'], exclude=[])
leadfield = forward['sol']['data']

lfd_evo = EvokedArray(leadfield[:,:10], info=evoked.info, tmin=0.)
...
# CHANGED evoked to lfd_evo
dipoles, residual = mixed_norm(
    lfd_evo, forward, cov, alpha, loose=loose, depth=depth, maxit=3000,
