...
4. The :doc:`API reference <python_reference>` provides documentation for the
   classes, functions and methods in the MNE-Python codebase. This is the same
...
The rest of this page provides links to other aspects of MNE-Python that are
outside of the five categories above:
