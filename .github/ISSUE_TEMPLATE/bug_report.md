...
to MNE-Python. For any other questions, please use the mailing list or Gitter.
Most usage questions that are posted as GitHub issues are closed without being
answered. See
