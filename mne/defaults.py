...
DEFAULTS = dict(
    ...
    ylim=dict(mag=(-600., 600.), grad=(-200., 200.),
              ...
              seeg=(-200., 200.), dipole=(-100., 100.), gof=(0., 1.)),
    titles=dict(eeg='EEG', grad='Gradiometers', mag='Magnetometers',
                misc='misc', seeg='sEEG', dipole='Dipole',
                gof='Goodness of fit'),
