...
from ..config import bst_phantom_ctf
...
def data_path(path=None, force_update=False, update_path=True, download=True,
    ...
    dataset_params = {'bst_phantom_ctf': bst_phantom_ctf}
    config_key = bst_phantom_ctf['config_key']
    folder_name = bst_phantom_ctf['folder_name']

    # get download path for specific dataset
    path = _get_path(path=path, key=config_key, name='bst_phantom_ctf')
