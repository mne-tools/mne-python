...
- Fix bug with :func:`~mne.viz.plot_raw` where :func:`~mne.set_config("MNE_BROWSER_BACKEND", "backend")` would have no effect within a script (:gh:`12078` by `Santeri Ruuskanen`_)
