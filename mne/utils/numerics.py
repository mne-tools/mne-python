...
def si_prefix(number, ten_hundred=False):
    ...
    corresponding to the next available prefix.
    ...
    ten_hundred : bool
        Whether to include prefixes for 10, 100, 1/10, and 1/100.
    ...
    """
    PREFIXES = {24: "Y", 21: "Z", 18: "E", 15: "P", 12: "T", 9: "G", 6: "M",
                3: "k", 0: "", -3: "m", -6: "µ", -9: "n", -12: "p", -15: "f",
                -18: "a", -21: "z", -24: "y"}
    if ten_hundred:
        PREFIXES = {**PREFIXES, **{2: "h", 1: "da", -1: "d", -2: "c"}}
    if number == 0:
        return number, ""
    index = round(log(abs(number), 10))
    while True:
        try:
            PREFIXES[index]
        except KeyError:
