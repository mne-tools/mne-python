...
.. glossary::
    ...
    Equivalent Current Dipole (ECD)
        ...
        synaptic sources are _equivalent_ to those generated by a mathematical
        idealisation of a point-like current source: a current dipole. The
        term ECD, or just "dipole", thus refers to the _source model_ of a
        patch of cortex, in which cells are experiencing post-synaptic
        activity (mainly excitation).
