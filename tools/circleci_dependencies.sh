...
if [[ "$CIRCLE_JOB" == "linkcheck"* ]]; then
	...
	python -m pip install --progress-bar off https://github.com/sphinx-gallery/sphinx-gallery/zipball/master https://github.com/larsoner/pyvista/zipball/version https://github.com/pyvista/pyvistaqt/zipball/main
