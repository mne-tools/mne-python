...
MNE-Python*, you should instead use `GitHub Discussions`_, write to the
`MNE mailing list`_ or chat with developers on the `MNE Gitter channel`_. Users
and contributors to MNE-Python are expected to follow our `code of conduct`_.
