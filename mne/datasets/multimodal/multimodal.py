...
@deprecated(extra=DEPRECATION_MESSAGE_TEMPLATE.format('multimodal'))
def has_multimodal_data():
    return has_dataset(name='multimodal')


has_multimodal_data.__doc__ = _HAS_DATA_DOCSTRING_TEMPLATE.format('multimodal')
