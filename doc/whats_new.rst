...
Changelog
~~~~~~~~~
- Add example on how to simulate raw data from the sample dataset, by `Ivana Kojcic`_,`Eric Larson`_,`Samuel Deslauriers-Gauthier`_ and`Kostiantyn Maksymenko`_
