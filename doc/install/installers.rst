...
.. tab-set::
    ...
    .. tab-item:: Linux
        ...
        .. button-link:: https://github.com/mne-tools/mne-installers/releases/download/v1.13.1/MNE-Python-1.13.1_0-Linux.sh
            :ref-type: ref
            :color: primary
            :shadow:
        ...
        **Supported platforms:** Ubuntu 20.04 (Focal Fossa) and newer
        ...
        .. code-block:: console
            ...
            $ sh ./MNE-Python-1.13.1_0-Linux.sh
    ...
    .. tab-item:: macOS (Intel)
        ...
        .. button-link:: https://github.com/mne-tools/mne-installers/releases/download/v1.13.1/MNE-Python-1.13.1_0-macOS_Intel.pkg
            :ref-type: ref
            :color: primary
            :shadow:
            :class: font-weight-bold mt-3 install-download-button
    ...
    .. tab-item:: macOS (Apple Silicon)
        ...
        .. button-link:: https://github.com/mne-tools/mne-installers/releases/download/v1.13.1/MNE-Python-1.13.1_0-macOS_M1.pkg
            :ref-type: ref
            :color: primary
            :shadow:
            :class: font-weight-bold mt-3 install-download-button
    ...
    .. tab-item:: Windows
        ...
        .. button-link:: https://github.com/mne-tools/mne-installers/releases/download/v1.13.1/MNE-Python-1.13.1_0-Windows.exe
            :ref-type: ref
            :color: primary
            :shadow:
            :class: font-weight-bold mt-3 install-download-button
   ...
   .. tab-set::
       ...
       .. tab-item:: Linux
           ...
           .. code-block:: bash
               ...
               $ which python
               /home/username/mne-python/1.13.1_0/bin/python
       ...
       .. tab-item:: macOS
           ...
           .. code-block:: bash
               ...
               $ which python
               /Users/username/Applications/MNE-Python/1.13.1_0/.mne-python/bin/python
