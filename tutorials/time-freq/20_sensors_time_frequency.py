...
#
#       commented::
#       # MNE-Python provides seven baseline modes: "mean", "ratio", "logratio",
#       # "meanlogratio", "percent", "zscore", "zlogratio"
#
#       “mean”: subtracts the mean baseline power. It is simple and remains in
...
#
#       “ratio”: expresses power relative to baseline. It is intuitive because values
...
#
#       “logratio”: expresses relative power on a log scale (dB). The log transformation
#       reduces skewness and make the increase or decrease more symmetric, while providing
#       a conveneient scale for comparing relative changes. However, Kinley et al. (2026)
...
#
#       #meanlogratio”: provides a logarithmic (dB) interpretation but avoids its negative
#       bias by averaging the log-transformed baseline rather than first averaging baseline power.
#       It retains the reduced skewness of the logarithmic transformation and ensures that
#       the baseline is zero on average. It is therefore preferable to logratio when a
#       multiplicative model and a logarithmic representation are desired (Kinley et al. 2026).
#
#       "percent”: expresses the percentage change from baseline, making the magnitude
...
#
#       “zscore”: expresses changes relative to the variability of the baseline, in
...
#
#       “zlogratio”: combines the logarithmic relative-power transformation with
