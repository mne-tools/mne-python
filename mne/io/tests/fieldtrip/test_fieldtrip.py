...
@pytest.mark.parametrize('cur_system, version', all_test_params)
def test_averaged(cur_system, version):
...
@testing.requires_testing_data
@pytest.mark.parametrize('cur_system, version', all_test_params)
def test_epoched(cur_system, version):
...
@testing.requires_testing_data
@pytest.mark.parametrize('cur_system, version', all_test_params)
def test_raw(cur_system, version):
