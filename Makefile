...
test-doc: sample_data testing_data
	$(PYTESTS) --tb=short --cov=mne --cov-report=xml --cov-append --doctest-modules --doctest-ignore-import-errors --doctest-glob='*.rst' ./doc/ --ignore=./doc/auto_examples --ignore=./doc/auto_tutorials --ignore=./doc/_build --ignore=./doc/conf.py --ignore=doc/sphinxext --fulltrace
