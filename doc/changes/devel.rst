...
- Fix bug where :func:`mne.io.read_raw_cnt` would not import bad channels and added header parameter for backwards compatibility (:gh:`11833` by `Jacob Woessner`_)
