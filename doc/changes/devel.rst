...
- Fix bug with :func:`mne.read_raw_eeglab` and :func:`mne.io.read_epochs_eeglab` where automatic fiducial detection would fail for certain files (:gh:`12165` by `Clemens Brunner`_) 
