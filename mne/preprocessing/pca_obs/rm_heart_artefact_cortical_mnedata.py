...
if __name__ == '__main__':
    ...
    ecg_events, ch_ecg, average_pulse, = find_ecg_events(raw)
    ...
    PCA_OBS_kwargs = dict(
        qrs=ecg_event_samples, filter_coords=fwts, sr=fs
    )

    epochs = Epochs(raw, ecg_events, tmin=iv_epoch[0], tmax=iv_epoch[1],
