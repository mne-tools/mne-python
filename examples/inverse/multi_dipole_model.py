...
evoked_fit_left.pick(picks_left, ordered=False)
cov_fit_left = cov.copy().pick(picks_left, ordered=False)

picks_right = read_vectorview_selection("Right", info=info)
evoked_fit_right = evoked_right.copy().crop(0.08, 0.08)
evoked_fit_right.pick(picks_right, ordered=False)
cov_fit_right = cov.copy().pick(picks_right, ordered=False)
