...
# See the filtering tutorial to learn how to deal with these artifacts
#     * :ref:`sphx_glr_auto_tutorials_plot_correction_filtering.py`
...
#     * :ref:`sphx_glr_auto_tutorials_plot_correction_rejection.py`
#     * :ref:`sphx_glr_auto_tutorials_plot_correction_ica_ssp.py`
