...
"""
docdict['baseline_epochs'] = """%(baseline_rescale)s
...
""" % docdict
docdict['baseline_evoked'] = """%(baseline_rescale)s
...
""" % docdict
docdict['baseline_stc'] = """%(baseline_rescale)s
...
""" % docdict
docdict['baseline_report'] = """%(baseline_rescale)s
