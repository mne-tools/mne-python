...
short_HPI_dip_fname = (
    artemis123_dir / "Artemis_Data_2017-04-04-15h-44m-22s_Motion_Translation-z.bin"
)
dig_fname = artemis123_dir / "Phantom_040417_dig.pos"
short_hpi_1kz_fname = (
    artemis123_dir / "Artemis_Data_2017-04-14-10h-38m-59s_Phantom_1k_HPI_1s.bin"
)
...
def test_dev_head_t():
    ...
    dev_head_t_1 = np.array(
        [
            [9.713e-01, 2.340e-01, -4.164e-02, 1.302e-04],
    ...
    dev_head_t_2 = np.array(
        [
            [9.890e-01, 1.475e-01, -8.090e-03, 4.997e-04],
    ...
    expected_dev_hpi_rr = np.array(
        [
            [-0.01579644, 0.06527367, 0.00152648],
    ...
    dev_hpi_rr = np.array(
        [p["r"] for p in raw.info["dig"] if p["coord_frame"] == FIFF.FIFFV_COORD_DEVICE]
    )
