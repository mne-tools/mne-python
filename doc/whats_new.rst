...
~~~~~~~~~
    ...
    - Add bootstrapped confidence intervals to :func:`mne.viz.plot_compare_evokeds` (that can for now also be accessed as :func:`mne.utils._boostrapped_ci`) by `Jona Sassenhagen`_ and `Denis Engemann`_
