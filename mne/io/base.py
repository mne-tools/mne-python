...
class _BaseRaw(ProjMixin, ContainsMixin, PickDropChannelsMixin,
    ...
    def plot(self, events=None, duration=10.0, start=0.0, n_channels=20,
        ...
        The scaling can be adjusted with - and + or = keys. Full screen mode
        can be to toggled with f11 key. To mark or un-mark a channel as bad,
        click on the rather flat segments of a channel's time series. The
        changes will be reflected immediately in the raw object's
        ``raw.info['bads']`` entry.
        """
