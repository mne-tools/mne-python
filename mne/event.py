...
def read_events(filename, include=None, exclude=None, mask=None,
                mask_type='not_and'):
    """Read events from fif or text file. See :ref:`tut_epoching_and_averaging`
    as well as :ref:`ex_read_events` for more information about events.
...
def find_events(raw, stim_channel=None, output='onset',
    ...
    """Find events from raw file. See :ref:`tut_epoching_and_averaging`
    as well as :ref:`ex_read_events` for more information about events.
