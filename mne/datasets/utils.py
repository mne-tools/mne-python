...
def _data_path(path=None, force_update=False, update_path=True, download=True,
    ...
    urls = dict(
        ...
        cichy='https://mne-tools.s3.amazonaws.com/datasets/MNE-cichy-data/%s',
    ...
    hashes = dict(
        brainstorm=None,
        cichy='aeca118b0730168195958d8333a27129',
