...
FIFF.FIFFV_COIL_FNIRS_PROCESSED_AMPLITUDE  = 308 # fNIRS processed amplitude
...
_ch_coil_type_named = {key: key for key in (
    ...
    FIFF.FIFFV_COIL_FNIRS_TD_MOMENTS_AMPLITUDE, FIFF.FIFFV_COIL_FNIRS_PROCESSED_AMPLITUDE,
