...
- Add :class:`mne.SourceMorph` with :meth:`mne.SourceMorph.save` and :meth:`mne.SourceMorph.as_volume`, :func:`mne.read_source_morph`, 
by `Tommy Clausner`_

- Deprecated :meth:`mne.VolSourceEstimate.morph_precomputed` 
and :func:`mne.morph_data_precomputed` in favor of 
:class:`mne.SourceMorph` by `Tommy Clausner`_
