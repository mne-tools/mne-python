...
_deprecation_ignores = [
    ...
    'mne.utils.generate_sparse_stc',  # deprecated
    'mne.utils.generate_stc',  # deprecated
    'mne.utils.generate_evoked',  # deprecated
    'mne.utils.generate_noise_evoked',  # deprecated
