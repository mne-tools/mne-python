...
DEFAULTS = dict(
    color=dict(mag='darkblue', grad='b', eeg='k', eog='k', ecg='m', emg='k',
               ...
               fnirs_cw_amplitude='k', fnirs_fd_dc_amplitude='k',
               fnirs_fd_ac_amplitude='k', fnirs_fd_phase='k',
               fnirs_od='k', csd='k'),
    units=dict(mag='fT', grad='fT/cm', eeg='µV', eog='µV', ecg='µV', emg='µV',
               ...
               fnirs_cw_amplitude='V', fnirs_fd_dc_amplitude='V',
               fnirs_fd_ac_amplitude='V', fnirs_fd_phase='V',
               fnirs_od='V', csd='mV/m²'),
    ...
    scalings=dict(mag=1e15, grad=1e13, eeg=1e6, eog=1e6, emg=1e6, ecg=1e6,
                  ...
                  fnirs_fd_dc_amplitude=1.0, fnirs_fd_ac_amplitude=1.0,
                  fnirs_fd_phase=1.0, fnirs_od=1.0, csd=1e3),
    ...
    scalings_plot_raw=dict(mag=1e-12, grad=4e-11, eeg=20e-6, eog=150e-6,
                           ...
                           fnirs_fd_dc_amplitude=2e-2,
                           fnirs_fd_ac_amplitude=2e-2, fnirs_fd_phase=2e-2,
    ...
    titles=dict(mag='Magnetometers', grad='Gradiometers', eeg='EEG', eog='EOG',
                ...
                fnirs_fd_dc_amplitude='fNIRS (FD DC amplitude)',
