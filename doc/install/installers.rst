...
.. tab-set::
    ...
    .. tab-item:: Linux
        ...
        .. button-link:: https://github.com/mne-tools/mne-installers/releases/download/v1.6.0/MNE-Python-1.6.0_0-Linux.sh
            :ref-type: ref
            :color: primary
            :shadow:
        ...
        **Supported platforms:** Ubuntu 18.04 (Bionic Beaver) and newer
        ...
        .. code-block:: console
            ...
            $ sh ./MNE-Python-1.6.0_0-Linux.sh
    ...
    .. tab-item:: macOS (Intel)
        ...
        .. button-link:: https://github.com/mne-tools/mne-installers/releases/download/v1.6.0/MNE-Python-1.6.0_0-macOS_Intel.pkg
            :ref-type: ref
            :color: primary
            :shadow:
            :class: font-weight-bold mt-3
    ...
    .. tab-item:: macOS (Apple Silicon)
        ...
        .. button-link:: https://github.com/mne-tools/mne-installers/releases/download/v1.6.0/MNE-Python-1.6.0_0-macOS_M1.pkg
            :ref-type: ref
            :color: primary
            :shadow:
            :class: font-weight-bold mt-3
    ...
    .. tab-item:: Windows
        ...
        .. button-link:: https://github.com/mne-tools/mne-installers/releases/download/v1.6.0/MNE-Python-1.6.0_0-Windows.exe
            :ref-type: ref
            :color: primary
            :shadow:
            :class: font-weight-bold mt-3
