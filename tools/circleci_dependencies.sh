...
if [[ "$CIRCLE_JOB" == "linkcheck"* ]]; then
	...
	python -m pip install --upgrade --progress-bar off https://github.com/mne-tools/mne-qt-browser/zipball/main git+https://github.com/alexrockhill/sphinx-gallery@api
