...
from ..config import bst_auditory
...
def data_path(path=None, force_update=False, update_path=True, download=True,
    ...
    dataset_params = {'bst_auditory': bst_auditory}
    config_key = bst_auditory['config_key']
    folder_name = bst_auditory['folder_name']

    # get download path for specific dataset
    path = _get_path(path=path, key=config_key, name='bst_auditory')
