...
class Evoked(ProjMixin, ContainsMixin, UpdateChannelsMixin, SetChannelsMixin,
    ...
    def plot(self, picks=None, exclude='bads', unit=True, show=True, ylim=None,
             ...
             set_tight_layout=True, spatial_colors=False, zorder='unsorted',
        ...
        return plot_evoked(
            ...
            window_title=window_title, set_tight_layout=set_tight_layout,
            spatial_colors=spatial_colors, zorder=zorder,
            selectable=selectable, noise_cov=noise_cov, time_unit=time_unit,
            sphere=sphere, verbose=verbose)
