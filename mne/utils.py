...
def random_permutation(n_samples, rng):
    ...
    than randperm matlab function whenever both, matlab and python random
    number generators (rng), use the same seed.
    ...
    random_permutation(n_samples, rng) function generates
    a random sequence between 0 and n_samples-1, that is:
    randperm(n_samples) = random_permutation(n_samples, rng) - 1
