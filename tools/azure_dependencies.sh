...
if [ "${TEST_MODE}" == "pip" ]; then
	...
	python -m pip install $STD_ARGS --only-binary ":all:" --extra-index-url "https://pypi.anaconda.org/scientific-python-nightly-wheels/simple" "numpy>=2.0.0.dev0" "scipy>=1.12.0.dev0" statsmodels scikit-learn matplotlib
	echo "dipy"
