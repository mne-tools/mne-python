...
DEFAULTS = dict(
    ...
    titles_short=dict(eeg='EEG', grad='Grad', mag='Mag',
                      misc='Misc', seeg='sEEG', dipole='Dip', eog='EOG',
                      gof='GOF', ecg='ECG', emg='EMG', bio='BIO',
                      ecog='ECoG', hbo='Oxy', hbr='Deoxy'),
