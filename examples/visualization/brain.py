...
# %%
# Now simulate a new data frame arriving: call
# :meth:`~mne.viz.LayeredMesh.update_overlay` to replace the scalars in-place —
# no new mesh, no new actor, no pipeline rebuild.
