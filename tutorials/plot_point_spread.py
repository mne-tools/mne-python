...
brain_gen_lat = stc_gen.plot(clim=clim, views=['lat'], **kwargs)
brain_gen_med = stc_gen.plot(clim=clim, views=['med'], **kwargs)
...
# sulci and gyri.
brain_inv_lat = stc_inv.plot(views=['lat'], **kwargs)
brain_inv_med = stc_inv.plot(views=['med'], **kwargs)
