...
def test_get_data_rounding():
    ...
    assert_allclose(val_get_data, val_crop, atol=1e-12, err_msg="get_data(tmin) does not match crop(tmin)")
    ...
    assert_allclose(val_get_data, val_direct, atol=1e-12, err_msg="get_data(tmin) does not match direct indexing")
