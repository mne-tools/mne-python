...
#   skewness while providing a interpretable scale for comparing relative changes.
...
#   (``AverageTFR``), because the bias scales with the variance of the quantity being
#   corrected.
#
# ``"meanlogratio”``
