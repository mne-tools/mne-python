...
#   - meg (mag) : For MEG magnetometers channels stored in T
#   - meg (grad) : For MEG gradiometers channels stored in T/m
#   - ecg : For ECG channels stored in V
#   - emg : For EMG channels stored in V
