"""
================================================================
Create whole-cortex searchlights (Olaf).
================================================================
...
# all vertices for left hemisphere
seeds = forward['src'][0]['vertno']

t0 = time.time()

searchlights = mne.grow_labels('sample', seeds=seeds, extents=10, hemis=hemis,
                               subjects_dir=subjects_dir,
                               n_jobs=1, overlap=False, names=None, surface='white')

t1 = time.time()

print('Time per vertex: %fs (overall: %fs).' % (((t1-t0)/len(seeds)), (t1-t0)))
